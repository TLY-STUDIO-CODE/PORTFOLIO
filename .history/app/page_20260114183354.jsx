    ...
    >
      ...
      <div className="flex flex-col xl:flex-row items-center justify-between w-full">
        ...
        <div className="w-full xl:w-[550px] flex flex-col items-center xl:items-start text-center xl:text-left">
          ...
          <Link href="/contact">
            <button className="btn btn-lg btn-accent mb-16">
              <div className="flex items-center gap-3 hover:rotate-45 transition-all cursor-pointer">
          ...
          <Socials 
            ...
            2xl:top-1/2 2xl:right-2 2xl:transform 2xl:-translate-x-1/2 
            2xl:-translate-y-1/2" 
            iconStyles="bg-accent text-white hover:bg-accent-hover 
            transition w-[48px] h-[48px] text-[22px] flex items-center justify-center rounded-full 
            cursor-pointer" 
          />
        </div>
        ...
        <div className="hidden xl:block flex-1 relative z-20">
          ...
          {/* avatar img */}
          <Image src={avatarImg} alt="" width={440} height={600} quality={100} className="absolute -top-12 left-[120px]" />
          {/* overlay gradient */}
