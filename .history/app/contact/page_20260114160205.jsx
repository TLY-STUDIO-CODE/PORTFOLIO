      ...
      <div className="w-full">
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="flex-1 xl:w-[600px] flex flex-col gap-12">
            <div>
              <h2 className="h2 mb-6">Me <span className="text-accent">contacter</span></h2>
              <p className="max-w-[460px]">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nihil, provident!</p>
            </div>
          </div>
          {/* form */}
