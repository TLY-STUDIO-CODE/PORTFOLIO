        ...
        <div className="flex flex-col xl:flex-row xl:items-center gap-8 xl:gap-12">
            <div className="flex gap-4">
                <div className="text-5xl font-bold text-accent flex">
                    ...
                    <CountUp end={3} duration={5} delay={2} className="block w-[60px]" formattingFn={formatNumber} />
                    <div>+</div>
                </div>
                <span>
            ...
            <div className="flex gap-4">
                <div className="text-5xl font-bold text-accent flex">
                    <CountUp end={6} duration={5} delay={2} className="block w-[60px]" formattingFn={formatNumber} />
                </div>
                <span>
                    Partenaires <br /> Satisfaits
                </span>
            </div>
        </div>
    );
